...
namespace ImGui
{
    ...
    // Styles
    IMGUI_API void          StyleColorsTurquoise(ImGuiStyle* dst = NULL);    //Torquoise style by wirekuro (default)
    IMGUI_API void          StyleColorsGold(ImGuiStyle* dst = NULL);    //Gold style by R3nzTheCodeGOD
